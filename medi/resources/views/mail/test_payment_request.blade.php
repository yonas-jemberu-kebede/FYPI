<!-- resources/views/emails/test_payment_request.blade.php -->
<!DOCTYPE html>
<html>
<head>
    <title>Test Payment Request</title>
    <meta charset="UTF-8">
...
<body>
    <div class="container">
        <h1>Test Payment Request</h1>
        <p>Dear {{ $patient_name }},</p>
        <p>Your test order has been successfully created. Below are the details of your test:</p>

        <div class="details">
            <p><strong>Ordered by:</strong> Dr. {{ $doctor_name }}</p>
